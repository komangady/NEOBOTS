...
function wp_trim_excerpt($text,$len=55) { // Fakes an excerpt if needed
	global $post;
	//if ( '' == $text ) {
		//$text = get_the_content($text);
...
function get_the_content($content, $more_link_text = '(more...)', $stripteaser = 0, $more_file = '') {
