<?php
global $NAMA_SERVER, $NAMA_USER, $PASSWORD,$id_mysql, $NAMA_DB;
...
if (! mysql_select_db($NAMA_DB, $id_mysql))
...
if(isset($_POST['action']))
{
	if(htmlentities($_POST['action'], ENT_QUOTES, 'UTF-8') == 'rating')
	{
		...
		*
		*/
		$sql="insert into wm_ratingresep(Id_Resep,rating_num)values('".$id."','".$rate."')";
		$cst=mysql_query($sql);
